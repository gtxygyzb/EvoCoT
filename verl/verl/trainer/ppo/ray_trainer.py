        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with _timer("step", timing_raw):
                    ...
                    prompts = tensor_dict["prompts"]
                    responses = tensor_dict["responses"]
                    ...
                    # print(batch)
                    # print("=" * 50)
                    # print("reward_shape:", reward_tensor.shape)
                    # print("reward_tensor:", reward_tensor[0])
                    total_reward = reward_tensor.sum()
